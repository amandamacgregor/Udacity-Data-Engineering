...
# Some helpful variables for staging tables

LOG_D = config.get('S3','LOG_DATA')
LOG_P = config.get('S3', 'LOG_JSONPATH')
SONG_D = config.get('S3', 'SONG_DATA')
